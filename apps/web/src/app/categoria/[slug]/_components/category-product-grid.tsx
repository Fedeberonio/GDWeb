                  ...
                  <div className="absolute left-4 top-4 flex flex-col gap-2">
                    ...
                    {product.status === "active" && (
                      <ProductSeasonalBadge
                        isSeasonal={true}
                        isRefrigerated={product.tags.some(tag => tag.toLowerCase().includes("refrigerado"))}
                      />
                    )}
                  </div>
                  {statusLabel && (
                ...
                <div className="flex flex-1 flex-col space-y-4 p-5">
                  ...
                  <div className="mt-auto flex flex-col gap-2">
                    <motion.button
                      ...
                      className={`inline-flex items-center justify-center gap-2 rounded-full px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition ${
                        isAdded
