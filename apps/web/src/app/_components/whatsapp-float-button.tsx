...
export function WhatsAppFloatButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-4 md:right-6 z-50 flex items-center gap-2 md:gap-3 rounded-full bg-[#25D366] px-4 py-3 md:px-5 md:py-4 shadow-2xl transition-all duration-300 hover:scale-110 hover:shadow-[#25D366]/50 active:scale-95 group"
    ...
    >
      ...
      {/* Texto que aparece en hover - solo desktop */}
