  ...
  return (
    <div style={{margin:0,padding:0,minHeight:'100vh',display:'flex',alignItems:'center',justifyContent:'center',backgroundColor:'#ffffff',fontFamily:'system-ui,-apple-system,sans-serif'}}>
      <div style={{textAlign:'center',padding:'24px'}}>
        ...
        <a href="/" style={{display:'inline-flex',alignItems:'center',justifyContent:'center',borderRadius:'9999px',backgroundColor:'#2d5016',padding:'8px 16px',fontSize:'14px',fontWeight:600,color:'#ffffff',textDecoration:'none'}}>Ir al inicio</a>
      </div>
    </div>
  );
}
